...
const _usersLoginDto = require("../dtos/users.login.dto");
...
let AuthRoute = class AuthRoute {
    initializeRoutes() {
        ...
        this.router.post(`${this.path}login`, (0, _validationMiddleware.default)(_usersLoginDto.LoginUsersDto, 'body'), this.authController.logIn);
        this.router.post(`${this.path}find_user_data`, _authMiddleware.default, this.authController.findUserData);
